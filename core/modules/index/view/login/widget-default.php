    	...
    	<?php setcookie("password_updated","",time()-18600);
    		...
    		<div class="panel panel-primary">
			  	...
			  	<div class="panel-body">
			    	<form accept-charset="UTF-8" name="formulario" role="form" method="post" action="index.php?view=processlogin">
                    <fieldset>
			    	  	<div class="form-group">
			    		    <input class="form-control" placeholder="Usuario" name="mail" type="text" value="admin">
			    		</div>
			    		<div class="form-group">
